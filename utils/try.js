            ...
            if (rpn._isNumber(opItem)) {
                ...
                while (opStack.length) {
                    ...
                    if (
                        (opItem === '√' &&
                            stackItem === '√' &&
                            rpn._precedence[stackItem] >
                                rpn._precedence[opItem]) ||
                        ((opItem !== '√' || stackItem !== '√') &&
                            rpn._precedence[stackItem] >=
                                rpn._precedence[opItem])
                    ) {
...
console.log(rpn.calculate('((-1+2) - 3)'));
console.log(rpn.calculate('1/2'));
console.log(rpn.calculate('12!'));
console.log(rpn.calculate('1.2-2'));
console.log(rpn.calculate('1.1+2'));
console.log(rpn.calculate('1*2'));
console.log(rpn.calculate('1*2'));
console.log(rpn.calculate('1*2'));
console.log(rpn.calculate('1*2'));
